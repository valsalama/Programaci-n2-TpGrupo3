...
public class TestPersonaVehiculo {
    ...
    public static void main(String[] args) {
        ...
        Persona p = new Persona("Juan Martinez", 1111); // Se crea la lista nula!!
        ...
        // 2 - Testear más metodos, incluso algunos sofisticados como ordenar y buscar vehiculos
        // 3 - El nodo tiene que tener el anterior, ojo que eso modifica los métodos
        // 4 - Yo omiti las interfaces para hacer más rápido el ejemplo
        // Ustedes tienen que poner las interfaces y usarlas bien
        // Ningún ítem es obligatorio, pero cuanto más completo más nota. 
    }
}
